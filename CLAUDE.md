...
- `README.md` + `AGENTS.md` are the canonical source of truth for `@sito/dashboard-app`.
- `.sito/*` is internal upstream reference material for `@sito/dashboard`; do not treat it as the primary integration guide for this package.
