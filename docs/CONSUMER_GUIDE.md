...
| `Dialog`                      | `open`, `title`, `handleClose`, `closeOnBackdropClick`, `mobileFullScreen`, `containerClassName`, `className`, `animationClass`                                                  | Base modal. Backdrop click is disabled by default; set `closeOnBackdropClick` to `true` to close on outside click.                                        |
